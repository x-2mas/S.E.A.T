...
execute unless data storage x_core flags{reload:1} run data modify storage x_core packs merge value {x_seat:116401} 
...
execute if data storage x_core packs{x_seat:116401} run scoreboard objectives add x_SEAT_ID dummy "Xmas Labs: S.E.A.T ID Register"
execute if data storage x_core packs{x_seat:116401} run scoreboard objectives add x_SEAT_TICK dummy "Xmas Labs: S.E.A.T Tick Register"
execute if data storage x_core packs{x_seat:116401} run scoreboard objectives add x_SEAT_SCROLLED dummy "Xmas Labs: S.E.A.T Scroll Tracking Register"
execute if data storage x_core packs{x_seat:116401} run scoreboard objectives add x_SEAT_MENU dummy "Xmas Labs: S.E.A.T Menu Register"
execute if data storage x_core packs{x_seat:116401} unless data storage x_seat flags run data modify storage x_seat flags set value {physics:1, rotationLock:0, bounceOffFloor:0, onlySitDown:0, onlyIfSneaking:0, safetyEjects:1, fallDamage:1, blockInventory:1, freezeRideOnAdjust:0, showPrompts:1}
execute if data storage x_core packs{x_seat:116401} run data remove storage x_seat flags.loadNotified
execute if data storage x_core packs{x_seat:116401} run schedule function x_seat:load_notify 3s
