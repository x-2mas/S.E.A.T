...
execute if entity @a[tag=x_SEAT_NS,tag=x_SEAT_ANCHOR_PLAYER] if entity @s[tag=!x_ATTACH] if entity @e[dy=-0.5,tag=!x_SEAT,tag=!x_SEAT_ANCHOR,tag=!x_SEAT_SENSOR,tag=!x_SEAT_NO_RIDE,type=!#x_seat:non_rideables] run scoreboard players reset @s x_SEAT_TICK
