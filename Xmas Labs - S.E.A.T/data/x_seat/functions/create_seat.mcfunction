...
execute positioned as @s rotated ~ 0 run tp @e[tag=x_SEAT_NS,tag=x_SEAT_BASE,tag=x_SEAT_UNLINKED,tag=!x_TP_KILL,sort=nearest,limit=1] ~ ~-1.3 ~ facing ^ ^-1.6 ^2
...
execute positioned as @s as @e[tag=x_SEAT_NS,tag=x_SEAT_BASE,tag=x_SEAT_UNLINKED,tag=!x_TP_KILL,sort=nearest,limit=1] at @s run scoreboard players set @s x_TICK 0
