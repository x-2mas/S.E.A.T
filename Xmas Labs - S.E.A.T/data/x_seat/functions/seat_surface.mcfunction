...
execute if data storage x_seat flags{blockInventory:1} if data entity @s {Tame:1b} run data modify entity @s {} merge value {Tame:0} 

execute if data storage x_seat flags{blockInventory:0} unless data entity @s {Tame:1b} run data modify entity @s {} merge value {Tame:1} 
...
execute if entity @s[nbt={ChestedHorse:1b}] run summon minecraft:item ~ ~1.5 ~ {Tags:[x_INV_LOADER,x_KILL_ON_UNINSTALL],PickupDelay:0,Item:{id:"minecraft:chest",Count:1b}}
execute if entity @s[nbt={ChestedHorse:1b}] run data modify entity @s ChestedHorse set value 0
